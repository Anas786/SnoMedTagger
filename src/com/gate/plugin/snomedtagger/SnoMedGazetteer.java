 ...
 * the definition file.
 */
@CreoleResource(name="SnoMed Gazetteer", comment="A list lookup component.", icon="gazetteer")
public class SnoMedGazetteer extends AbstractGazetteer
